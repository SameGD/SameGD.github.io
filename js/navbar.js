...
var css = `a:hover { color: ${colorman} !important; } .accent-bg { background-color: ${colorman + '1A'}; } .accent-bg-full { background-color: ${colorman}; } .accent-top { border-top-color: ${colorman}; } .accent-bottom { border-bottom-color: ${colorman}; } .accent-left { border-left-color: ${colorman}; } .accent-right { border-right-color: ${colorman};} .accent-text { color: ${colorman} !important; } .accent-hover:hover { background-color: ${colorman + '0D'}; } .tabs .tab:hover { background-color: ${colorman + '0D'} !important; } .tabs .indicator { background-color: ${colorman} !important; } .tabs .tab a:focus { background-color: ${colorman + '0D'} !important;} .tabs .tab .active { color: ${colorman} !important; background-color: ${colorman + '0D'} !important; } .tabs-vertical .tab .active {background: linear-gradient(90deg, ${colorman + '0D'}, #ffffff);} .topic-bg { background: linear-gradient(180deg, ${colorman + '1A'} 76%, #00000000 0%) } `;
